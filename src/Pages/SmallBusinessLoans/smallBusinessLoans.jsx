          ...
          <div className="border-2 p-10">
            <div className="py-6">
              ...
              <p className="text-xl font-semibold py-5">
                Complete the application below with some basic information to
                see which financing options you qualify for and to be paired
                with a Business Financing Advisor!
              </p>
            </div>
            ...
            <form>
              ...
              <div className="pb-10">
                ...
                <label>
                  ...
                  policy as well as receiving SMS, email and phone
                  communication.
                </label>
              </div>
